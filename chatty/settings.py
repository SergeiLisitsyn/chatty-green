...
DATABASE_URL= f'postgres://${os.getenv('PG_USER')}:${os.getenv('PG_PASSWORD')}@${os.getenv('PG_HOST')}:${os.getenv('PG_PORT')}/${os.getenv('PG_NAME')}'
# Password validation
...
"""if not os.environ.get('EMAIL_HOST_USER') or not os.getenv('EMAIL_HOST_PASSWORD'):
    raise ValueError(
