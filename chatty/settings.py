...
ALLOWED_HOSTS = ['chatty-green.onrender.com', 'localhost', '127.0.0.1', 'web']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'), os.path.join(BASE_DIR, 'users/templates'), ], #  это для папки с шаблонами пользователей ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
