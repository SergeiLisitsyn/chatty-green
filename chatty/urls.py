...
from .views import search_view, welcome, home, search_results, RecommendedPostsView
...
urlpatterns = [
    ...
    path('search/', RecommendedPostsView.as_view(), name='search'),  #  Поиск публикаций and videos(функция `search_results`)
